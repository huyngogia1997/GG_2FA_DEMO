...
public class Utils {
    ...
    public static BufferedImage createQRCode(String secretKey,String email,String companyName,int heigh,int width) throws IOException, WriterException {
        String barCodeUrl = Utils.getGoogleAuthenticatorBarCode(secretKey, email, companyName);
        return Utils.createQRCode(barCodeUrl, heigh, width);
